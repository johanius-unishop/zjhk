var Swiper = (function () {
    ...
    var D = {
        ...
        updateSlides: function () {
            ...
            for (let a = 0; a < p; a += 1) {
                let i;
                if (((P = 0), c[a] && (i = c[a]), L && e.grid.updateSlide(a, i, c), !c[a] || "none" !== y(i, "display"))) {
                    if ("auto" === s.slidesPerView) {
                        k && (c[a].style[e.getDirectionLabel("width")] = "");
                        const r = getComputedStyle(i),
                            n = i.style.transform,
                            l = i.style.webkitTransform;
                        if ((n && (i.style.transform = "none"), l && (i.style.webkitTransform = "none"), s.roundLengths)) P = e.isHorizontal() ? T(i, "width", !0) : T(i, "height", !0);
                        else {
                            const e = t(r, "width"),
                                s = t(r, "padding-left"),
                                a = t(r, "padding-right"),
                    ...
                    } else (P = (r - (s.slidesPerView - 1) * E) / s.slidesPerView), s.roundLengths && (P = Math.floor(P)), c[a] && (c[a].style[e.getDirectionLabel("width")] = `${P}px`);
                    c[a] && (c[a].swiperSlideSize = P),
                        ...
                        s.centeredSlides
                            ? ((x = x + P / 2 + M / 2 + E),
                                ...
                                h.push(x))
                            : (s.roundLengths && (x = Math.floor(x)), (C - Math.min(e.params.slidesPerGroupSkip, C)) % e.params.slidesPerGroup == 0 && u.push(x), h.push(x), (x = x + P + E)),
                        (e.virtualSize += P + E),
                        (M = P),
                        (C += 1);
                }
            ...
            if (
                ((e.virtualSize = Math.max(e.virtualSize, r) + w),
                    n && l && ("slide" === s.effect || "coverflow" === s.effect) && (a.style.width = `${e.virtualSize + E}px`),
                    s.setWrapperSize && (a.style[e.getDirectionLabel("width")] = `${e.virtualSize + E}px`),
            ...
            if (o && s.loop) {
                ...
                for (let a = 0; a < e.virtual.slidesBefore + e.virtual.slidesAfter; a += 1) 1 === s.slidesPerGroup && u.push(u[u.length - 1] + t), h.push(h[h.length - 1] + t), (e.virtualSize += t);
            }
            ...
            if ((Object.assign(e, { slides: c, snapGrid: u, slidesGrid: h, slidesSizesGrid: f }), s.centeredSlides && s.cssMode && !s.centeredSlidesBounds)) {
                m(a, "--swiper-centered-offset-before", -u[0] + "px"), m(a, "--swiper-centered-offset-after", e.size / 2 - f[f.length - 1] / 2 + "px");
                ...
                if (y.length > 0 && T) {
                    if (void 0 === t) {
                        ...
                        l
                            ...
                            : (o.slideTo(E + M, 0, !1, !0), i && ((o.touchEventsData.startTranslate = o.touchEventsData.startTranslate - t), (o.touchEventsData.currentTranslate = o.touchEventsData.currentTranslate - t)));
                    } else if (i) {
                    ...
                    if (void 0 === t) {
                        ...
                        l
                            ? o.setTranslate(o.translate - t)
                            : (o.slideTo(E - C, 0, !1, !0), i && ((o.touchEventsData.startTranslate = o.touchEventsData.startTranslate - t), (o.touchEventsData.currentTranslate = o.touchEventsData.currentTranslate - t)));
                    } else {
    ...
    function X(e) {
        ...
        r.oneWayMovement && ((v = Math.abs(v) * (l ? 1 : -1)), (g = Math.abs(g) * (l ? 1 : -1))), (n.diff = v), (v *= r.touchRatio), l && ((v = -v), (g = -g));
        ...
        if ((new Date().getTime(), i.isMoved && i.allowThresholdMove && w !== s.touchesDirection && b && y && Math.abs(v) >= 1))
            ...
            (r.touchReleaseOnEdges && (E = 0),
                v > 0
                    ? (b &&
                        ...
                        i.currentTranslate > s.minTranslate() && ((S = !1), r.resistance && (i.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + i.startTranslate + v) ** E)))
                    : v < 0 &&
                    (b &&
                        y &&
                        i.allowThresholdMove &&
                        ...
                        i.currentTranslate < s.maxTranslate() && ((S = !1), r.resistance && (i.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - i.startTranslate - v) ** E))),
    ...
    function V(e) {
        ...
        if (m > r.longSwipesMs) {
            ...
            "next" === t.swipeDirection && (y >= r.longSwipesRatio ? t.slideTo(r.rewind && t.isEnd ? w : v + S) : t.slideTo(v)),
                "prev" === t.swipeDirection && (y > 1 - r.longSwipesRatio ? t.slideTo(v + S) : null !== b && y < 0 && Math.abs(y) > r.longSwipesRatio ? t.slideTo(b) : t.slideTo(v));
        } else {
            ...
            t.navigation && (i.target === t.navigation.nextEl || i.target === t.navigation.prevEl)
                ? i.target === t.navigation.nextEl
                    ? t.slideTo(v + S)
                    : t.slideTo(v)
                : ("next" === t.swipeDirection && t.slideTo(null !== w ? w : v + S), "prev" === t.swipeDirection && t.slideTo(null !== b ? b : v));
        }
    }
    function R() {
        const e = this,
    ...
    const K = (e, t) => {
        ...
        s[d]("touchstart", e.onDocumentTouchStart, { passive: !1, capture: o }),
            ...
            i.updateOnWindowResize ? e[c](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", R, !0) : e[c]("observerUpdate", R, !0),
        ...
        return function (s) {
            ...
            "object" == typeof i && null !== i
                ? (!0 === e[a] && (e[a] = { enabled: !0 }),
                    ...
                    a in e && "enabled" in i ? ("object" != typeof e[a] || "enabled" in e[a] || (e[a].enabled = !0), e[a] || (e[a] = { enabled: !1 }), u(t, s)) : u(t, s))
                : u(t, s);
        };
    }
    const ee = {
        ...
        transition: {
            ...
            transitionStart: function (e, t) {
                ...
                const s = this,
                    { params: a } = s;
                a.cssMode || (a.autoHeight && s.updateAutoHeight(), H({ swiper: s, runCallbacks: e, direction: t, step: "Start" }));
            },
            transitionEnd: function (e, t) {
                void 0 === e && (e = !0);
                const s = this,
                    { params: a } = s;
                (s.animating = !1), a.cssMode || (s.setTransition(0), H({ swiper: s, runCallbacks: e, direction: t, step: "End" }));
            },
        },
        slide: G,
        loop: _,
        ...
        breakpoints: {
            setBreakpoint: function () {
                ...
                Object.assign(e, { allowTouchMove: e.params.allowTouchMove, allowSlideNext: e.params.allowSlideNext, allowSlidePrev: e.params.allowSlidePrev }),
                    ...
                    s && (m ? (e.loopDestroy(), e.loopCreate(t), e.updateSlides()) : !h && v ? (e.loopCreate(t), e.updateSlides()) : h && !v && e.loopDestroy()),
                    e.emit("breakpoint", l);
            },
    ...
    class se {
        ...
        getSlideIndex(e) {
            const { slidesEl: t, params: s } = this,
                a = S(v(t, `.${s.slideClass}, swiper-slide`)[0]);
            return S(e) - a;
        }
    ...
    const he = [
        function (e) {
            ...
            function d(e, t) {
                ...
                let i;
                return (
                    a.renderSlide ? ((i = a.renderSlide.call(s, e, t)), "string" == typeof i && ((o.innerHTML = i), (i = o.children[0]))) : (i = s.isElement ? w("swiper-slide") : w("div", s.params.slideClass)),
            ...
            function c(e) {
                ...
                let g, w, b;
                (g = s.rtlTranslate ? "right" : s.isHorizontal() ? "left" : "top"), i ? ((w = Math.floor(t / 2) + a + o), (b = Math.floor(t / 2) + a + l)) : ((w = t + (a - 1) + o), (b = (r ? t : a) + l));
                let y = f - b,
                    S = f + w;
                r || ((y = Math.max(y, 0)), (S = Math.min(S, u.length - 1)));
                let E = (s.slidesGrid[y] || 0) - (s.slidesGrid[0] || 0);
                function x() {
                    s.updateSlides(), s.updateProgress(), s.updateSlidesClasses(), n("virtualUpdate");
                }
                if (
                    (r && f >= b ? ((y -= b), i || (E += s.slidesGrid[0])) : r && f < b && ((y = -b), i && (E += s.slidesGrid[0])),
                        Object.assign(s.virtual, { from: y, to: S, offset: E, slidesGrid: s.slidesGrid, slidesBefore: b, slidesAfter: w }),
                        c === y && p === S && !e)
                )
                    return (
                        s.slidesGrid !== m &&
                ...
                if (s.params.virtual.renderExternal)
                    return (
                        s.params.virtual.renderExternal.call(s, {
                            ...
                            slides: (function () {
                                const e = [];
                                for (let t = y; t <= S; t += 1) e.push(u[t]);
                                return e;
                            })(),
                        }),
        ...
        function (e) {
            ...
            function v(e) {
                ...
                if (0 === m) return !0;
                r.invert && (m = -m);
                let g = t.getTranslate() + m * r.sensitivity;
                if (
        ...
        function (e) {
            ...
            function c() {
                ...
                let s = r(e.nextEl),
                    a = r(e.prevEl);
                Object.assign(t.navigation, { nextEl: s, prevEl: a }), (s = M(s)), (a = M(a));
                const i = (s, a) => {
            ...
            s({
                ...
                a("enable disable", () => {
                    let { nextEl: e, prevEl: s } = t.navigation;
                    (e = M(e)), (s = M(s)), t.enabled ? l() : [...e, ...s].filter((e) => !!e).forEach((e) => e.classList.add(t.params.navigation.lockClass));
                }),
                a("click", (e, s) => {
        ...
        function (e) {
            ...
            function c(e) {
                ...
                if (!s) return;
                e.preventDefault();
                const a = S(s) * t.params.slidesPerGroup;
                if (t.params.loop) {
            ...
            function p() {
                ...
                if (
                    ...
                    if (
                        (s.dynamicBullets &&
                            ((n = T(i[0], t.isHorizontal() ? "width" : "height", !0)),
                                c.forEach((e) => {
            ...
            Object.assign(t.pagination, {
                enable: () => {
                    ...
                    let { el: e } = t.pagination;
                    e && ((e = M(e)), e.forEach((e) => e.classList.remove(t.params.pagination.paginationDisabledClass))), m(), u(), p();
                },
                disable: f,
                render: u,
                update: p,
        ...
        function (e) {
            ...
            function S(e) {
                const { scrollbar: s, rtlTranslate: a } = t,
                    { el: i } = s;
                let r;
                (r = (y(e) - b(i)[t.isHorizontal() ? "left" : "top"] - (null !== d ? d : c / 2)) / (p - c)), (r = Math.max(Math.min(r, 1), 0)), a && (r = 1 - r);
            ...
            function x(e) {
                const { scrollbar: s, wrapperEl: a } = t,
                    { el: i, dragEl: n } = s;
                m && (e.preventDefault ? e.preventDefault() : (e.returnValue = !1), S(e), (a.style.transitionDuration = "0ms"), (i.style.transitionDuration = "0ms"), (n.style.transitionDuration = "0ms"), r("scrollbarDragMove", e));
            }
            function T(e) {
                const s = t.params.scrollbar,
                    { scrollbar: a, wrapperEl: i } = t,
            ...
            function C(e) {
                ...
                r[d]("pointerdown", E, n), o[d]("pointermove", x, n), o[d]("pointerup", T, l);
            }
            function L() {
                ...
                t.params.uniqueNavElements && "string" == typeof a.el && i.length > 1 && 1 === s.querySelectorAll(a.el).length && (i = s.querySelector(a.el)),
                    ...
                    i && ((r = i.querySelector(ie(t.params.scrollbar.dragClass))), r || ((r = w("div", t.params.scrollbar.dragClass)), i.append(r))),
            ...
            s({
                ...
                i("init", () => {
                    !1 === t.params.scrollbar.enabled ? k() : (L(), g(), v());
                }),
            ...
            Object.assign(t.scrollbar, {
                enable: () => {
                    t.el.classList.remove(...n(t.params.scrollbar.scrollbarDisabledClass)), t.scrollbar.el && t.scrollbar.el.classList.remove(...n(t.params.scrollbar.scrollbarDisabledClass)), L(), g(), v();
                },
                disable: k,
                updateSize: g,
                setTranslate: v,
        ...
        function (e) {
            ...
            function S(e) {
                ...
                if (((l = !1), (o = !1), u.push(e), !(u.length < 2))) {
                    if (((l = !0), (m.scaleStart = w()), !m.slideEl)) {
            ...
            function L(e) {
                ...
                let i, r, l, o, d, p, u, f, g, w, y, S, x, T, M, C, L, P;
                ...
                1 === c && k && ((i = void 0), (r = void 0)),
                    (s.scale = k || m.imageWrapEl.getAttribute("data-swiper-zoom") || a.maxRatio),
                    (c = k || m.imageWrapEl.getAttribute("data-swiper-zoom") || a.maxRatio),
                    !e || (1 === c && k)
                        ? ((u = 0), (f = 0))
                        : ((L = m.slideEl.offsetWidth),
                            (P = m.slideEl.offsetHeight),
                            (l = b(m.slideEl).left + n.scrollX),
                            (o = b(m.slideEl).top + n.scrollY),
                            (d = l + L / 2 - i),
                            (p = o + P / 2 - r),
            ...
            Object.defineProperty(t.zoom, "scale", {
                ...
                Object.assign(t.zoom, { enable: I, disable: z, in: L, out: P, toggle: k });
        },
        function (e) {
            let { swiper: t, extendParams: s, on: a } = e;
            function i(e, t) {
        ...
        function (e) {
            ...
            function m(e) {
                ...
                const s = t.params.a11y,
                    a = e.target;
                (t.pagination && t.pagination.el && (a === t.pagination.el || t.pagination.el.contains(e.target)) && !e.target.matches(ie(t.params.pagination.bulletClass))) ||
            ...
            const v = (e, t, s) => {
                ...
                x = () => {
                    ...
                    if (((p = M(p)), (u = M(u)), p && p.forEach((t) => v(t, r, e.nextSlideMessage)), u && u.forEach((t) => v(t, r, e.prevSlideMessage)), f())) {
                        M(t.pagination.el).forEach((e) => {
                            e.addEventListener("keydown", m);
                        });
                    }
                    t.el.addEventListener("focus", y, !0), t.el.addEventListener("pointerdown", g, !0), t.el.addEventListener("pointerup", b, !0);
                };
            a("beforeInit", () => {
                (i = w("span", t.params.a11y.notificationClass)), i.setAttribute("aria-live", "assertive"), i.setAttribute("aria-atomic", "true");
            }),
                a("afterInit", () => {
                        ...
                        (function () {
                            ...
                            h() &&
                                t.pagination.bullets.forEach((s) => {
                                    t.params.pagination.clickable && (n(s), t.params.pagination.renderBullet || (o(s, "button"), c(s, e.paginationBulletMessage.replace(/\{\{index\}\}/, S(s) + 1)))),
                ...
                a("destroy", () => {
                    t.params.a11y.enabled &&
                        (function () {
                            ...
                            t.el.removeEventListener("focus", y, !0), t.el.removeEventListener("pointerdown", g, !0), t.el.removeEventListener("pointerup", b, !0);
                        })();
                });
        },
        function (e) {
        ...
        function (e) {
            ...
            let d,
                ...
                b = new Date().getTime();
            function y(e) {
                i && !i.destroyed && i.wrapperEl && e.target === i.wrapperEl && (i.wrapperEl.removeEventListener("transitionend", y), v || C());
            }
            const S = () => {
                ...
                E = (e) => {
                    ...
                    !Number.isNaN(r) && r > 0 && void 0 === e && ((a = r), (g = r), (w = r)), (d = a);
                ...
                P = (e) => {
                    "mouse" === e.pointerType && ((f = !0), (v = !0), i.animating || i.autoplay.paused || M(!0));
                },
                k = (e) => {
                    "mouse" === e.pointerType && ((v = !1), i.autoplay.paused && C());
                };
            n("init", () => {
                i.params.autoplay.enabled && (i.params.autoplay.pauseOnMouseEnter && (i.el.addEventListener("pointerenter", P), i.el.addEventListener("pointerleave", k)), a().addEventListener("visibilitychange", L), x());
            }),
                n("destroy", () => {
                    i.el.removeEventListener("pointerenter", P), i.el.removeEventListener("pointerleave", k), a().removeEventListener("visibilitychange", L), i.autoplay.running && T();
                }),
                ...
                Object.assign(i.autoplay, { start: x, stop: T, pause: M, resume: C });
        },
        function (e) {
        ...
        function (e) {
            ...
            const i = (e, t, s) => {
                ...
                a || ((a = w("div", ("swiper-slide-shadow-cube swiper-slide-shadow-" + (s ? "left" : "top")).split(" "))), e.append(a)),
                    i || ((i = w("div", ("swiper-slide-shadow-cube swiper-slide-shadow-" + (s ? "right" : "bottom")).split(" "))), e.append(i)),
            ...
            ce({
                ...
                setTranslate: () => {
                    ...
                    c.shadow &&
                        (p
                            ? ((m = t.wrapperEl.querySelector(".swiper-cube-shadow")), m || ((m = w("div", "swiper-cube-shadow")), t.wrapperEl.append(m)), (m.style.height = `${r}px`))
                            : ((m = e.querySelector(".swiper-cube-shadow")), m || ((m = w("div", "swiper-cube-shadow")), e.append(m))));
                    for (let e = 0; e < a.length; e += 1) {
                        const s = a[e];
                        let r = e;
                        ...
                        let f = 0,
                            v = 0,
                            g = 0;
                        r % 4 == 0 ? ((f = 4 * -d * o), (g = 0)) : (r - 1) % 4 == 0 ? ((f = 0), (g = 4 * -d * o)) : (r - 2) % 4 == 0 ? ((f = o + 4 * d * o), (g = o)) : (r - 3) % 4 == 0 && ((f = -o), (g = 3 * o + 4 * o * d)),
                            l && (f = -f),
                            p || ((v = f), (f = 0));
                        const w = `rotateX(${p ? 0 : -n}deg) rotateY(${p ? n : 0}deg) translate3d(${f}px, ${v}px, ${g}px)`;
                    ...
                    setTranslate: () => {
                        ...
                        for (let e = 0, s = a.length; e < s; e += 1) {
                            ...
                            let m = n ? d * u : 0,
                                ...
                                f = -c * Math.abs(u),
                                v = r.stretch;
                            "string" == typeof v && -1 !== v.indexOf("%") && (v = (parseFloat(r.stretch) / 100) * l);
                            let g = n ? 0 : v * u,
                                w = n ? v * u : 0,
                            ...
                            const y = `translate3d(${w}px,${g}px,${f}px)  rotateX(${h}deg) rotateY(${m}deg) scale(${b})`;
            ...
            ce({
                ...
                setTranslate: () => {
                    ...
                    for (let s = 0; s < e.length; s += 1) {
                        ...
                        const S = pe(0, a);
                        (S.style.transform = y), (S.style.opacity = b), f.origin && (S.style.transformOrigin = f.origin);
                    }
                },
                setTransition: (e) => {
                    const s = t.slides.map((e) => f(e));
                    ...
                    setTranslate: () => {
                        ...
                        for (let o = 0; o < e.length; o += 1) {
                            ...
                            const b = t.virtual && t.params.virtual.enabled ? t.virtual.from + o : o,
                                ...
                                S = (b === s || b === s + 1) && p < 0 && p > -1 && (n || t.params.cssMode) && l > r;
                            if (y || S) {
                                const e = (1 - Math.abs((Math.abs(p) - 0.5) / 0.5)) ** 0.5;
                                (g += -28 * p * e), (v += -0.5 * e), (w += 96 * e), (h = -25 * e * Math.abs(p) + "%");
                            }
...
if (null != document.querySelector(".main-slider-1-1")) {
    var sliderMain1_animSpeed = 1e3;
    const e = new Swiper(".main-slider-1-2", {
        direction: "horizontal",
        loop: !1,
        speed: sliderMain1_animSpeed,
        initialSlide: 0,
        slidesPerView: 1,
        allowTouchMove: !1,
        grabCursor: !1,
        pagination: { el: ".slider-pagination", type: "fraction" },
        breakpoints: { 0: { allowTouchMove: !0, grabCursor: !0, spaceBetween: 10 }, 768: { spaceBetween: 0 } },
    }),
        t = new Swiper(".main-slider-1-1", { direction: "horizontal", loop: !0, speed: sliderMain1_animSpeed, initialSlide: e.slides.length - 1, slidesPerView: 2, allowTouchMove: !1, grabCursor: !1 }),
        s = document.querySelector(".section-2 .btn-slider-arrow.prev");
    s.addEventListener("click", function () {
        t.slidePrev(sliderMain1_animSpeed, !0), e.slidePrev(sliderMain1_animSpeed, !0), toggleBtnEvent(), a.removeAttribute("disabled");
    });
    const a = document.querySelector(".section-2 .btn-slider-arrow.next");
    a.addEventListener("click", function () {
        t.slideNext(sliderMain1_animSpeed, !0), e.slideNext(sliderMain1_animSpeed, !0), toggleBtnEvent(), s.removeAttribute("disabled");
    }),
        e.on("reachBeginning", function () {
            s.setAttribute("disabled", "");
        }),
        e.on("reachEnd", function () {
            a.setAttribute("disabled", "");
        });
    const i = document.querySelector(".slide-title"),
        r = document.querySelector(".slide-desc");
    function toggleBtnEvent() {
        (s.style.pointerEvents = "none"),
            (a.style.pointerEvents = "none"),
            setTimeout(function () {
                (s.style.pointerEvents = "auto"), (a.style.pointerEvents = "auto");
            }, sliderMain1_animSpeed);
    }
    e.on("slideChange", function () {
        (i.innerHTML = e.slides[e.activeIndex].dataset.title), (r.innerHTML = e.slides[e.activeIndex].dataset.desc);
    });
}
var sliderMain2_animSpeed = 1e3;
const sliderMain2 = new Swiper(".main-slider-2", {
    direction: "horizontal",
    loop: !0,
    speed: sliderMain2_animSpeed,
    initialSlide: 0,
    centeredSlides: !0,
    slidesPerView: 3,
    allowTouchMove: !1,
    grabCursor: !1,
    effect: "creative",
    navigation: { nextEl: ".section-5 .btn-slider-arrow.next", prevEl: ".section-5 .btn-slider-arrow.prev" },
    breakpoints: {
        0: { allowTouchMove: !0, grabCursor: !0, creativeEffect: { prev: { scale: 0.74, translate: ["-115%", 0, 0] }, next: { scale: 0.74, translate: ["115%", 0, 0] } } },
        768: { creativeEffect: { prev: { scale: 0.74, translate: ["-125%", "-4%", 0] }, next: { scale: 0.74, translate: ["125%", "-4%", 0] } } },
        1024: { creativeEffect: { prev: { scale: 0.74, translate: ["-145%", "-4%", 0] }, next: { scale: 0.74, translate: ["145%", "-4%", 0] } } },
    },
});
sliderMain2.on("slideChangeTransitionStart", function () {
    var e = document.querySelector(".main-slider-2 .swiper-slide-active .title");
    document.querySelector(".section-5 .slide-title").innerHTML = e.innerText;
});
var sliderFactoriesTabs_animSpeed = 500;
const sliderFactoriesTabs = new Swiper(".modal .swiper.nav-tabs", {
    direction: "horizontal",
    loop: !1,
    speed: sliderFactoriesTabs_animSpeed,
    initialSlide: 0,
    centeredSlides: !1,
    slidesPerView: "auto",
    spaceBetween: 5,
...
var sliderManufacturersTabs_animSpeed = 500;
const sliderManufacturersTabs = new Swiper(".section-catalog.manufacturers .swiper.nav-tabs", {
    direction: "horizontal",
    loop: !1,
    speed: sliderManufacturersTabs_animSpeed,
    initialSlide: 0,
    centeredSlides: !1,
    slidesPerView: "auto",
    spaceBetween: 5,
...
var sliderManufacturerTabs_animSpeed = 500;
const sliderManufacturerTabs = new Swiper(".section-catalog.manufacturer .swiper.nav-tabs", {
    direction: "horizontal",
    loop: !1,
    speed: sliderManufacturerTabs_animSpeed,
    initialSlide: 0,
    centeredSlides: !1,
    slidesPerView: "auto",
    allowTouchMove: !0,
    grabCursor: !0,
    freeMode: !0,
    breakpoints: { 0: { spaceBetween: 20 }, 768: { spaceBetween: 30 }, 1024: { spaceBetween: 40 } },
});
var sliderProduct_animSpeed = 1e3;
const sliderProductThumbs = new Swiper(".slider-product-thumbs", { direction: "horizontal", loop: !1, speed: sliderProduct_animSpeed, initialSlide: 0, slidesPerView: 8, spaceBetween: 20, freeMode: !0, watchSlidesProgress: !0 }),
    sliderProduct = new Swiper(".slider-product", {
        direction: "horizontal",
        loop: !1,
        speed: sliderProduct_animSpeed,
        initialSlide: 0,
        slidesPerView: 1,
        thumbs: { swiper: sliderProductThumbs },
        navigation: { nextEl: ".btn-slider-arrow.next", prevEl: ".btn-slider-arrow.prev" },
        breakpoints: { 0: { allowTouchMove: !0, grabCursor: !0, spaceBetween: 15, pagination: { el: ".swiper-pagination" } }, 768: { allowTouchMove: !1, grabCursor: !1, spaceBetween: 20 } },
    });
var sliderOtherModels_animSpeed = 500;
const sliderOtherModels = new Swiper(".slider-other-models", {
    direction: "horizontal",
    loop: !1,
    speed: sliderOtherModels_animSpeed,
    initialSlide: 0,
    centeredSlides: !1,
    allowTouchMove: !0,
    grabCursor: !0,
    scrollbar: { el: ".swiper-scrollbar", hide: !1 },
    breakpoints: { 0: { slidesPerView: 1, spaceBetween: 10 }, 768: { slidesPerView: 2, spaceBetween: 20 }, 1024: { slidesPerView: 4, spaceBetween: 30 } },
});
var sliderPortfolio_animSpeed = 500;
const sliderPortfolio = new Swiper(".slider-portfolio", {
    direction: "horizontal",
    loop: !1,
    speed: sliderPortfolio_animSpeed,
    initialSlide: 0,
    centeredSlides: !1,
    slidesPerView: 3,
    spaceBetween: 45,
    ...
    freeMode: !0,
    scrollbar: { el: ".swiper-scrollbar", hide: !1 },
    breakpoints: { 0: { slidesPerView: "auto", spaceBetween: 20 }, 768: { slidesPerView: 2, spaceBetween: 30 }, 1024: { slidesPerView: 3, spaceBetween: 45 } },
});
var sliderReviewImgs_animSpeed = 500;
const sliderReviewImgs = new Swiper(".slider-review-imgs", {
    direction: "horizontal",
    loop: !1,
    speed: sliderReviewImgs_animSpeed,
    initialSlide: 0,
    centeredSlides: !1,
    slidesPerView: "auto",
    allowTouchMove: !0,
    grabCursor: !0,
    freeMode: !0,
    breakpoints: { 0: { spaceBetween: 10 }, 768: { spaceBetween: 20 }, 1024: { spaceBetween: 30 } },
});
var sliderTags_animSpeed = 500;
const sliderTags = new Swiper(".slider-tags", {
    direction: "horizontal",
    loop: !1,
    speed: sliderTags_animSpeed,
    initialSlide: 0,
    centeredSlides: !1,
    slidesPerView: "auto",
    allowTouchMove: !0,
    grabCursor: !0,
    freeMode: !0,
    breakpoints: { 0: { spaceBetween: 5 }, 768: { spaceBetween: 10 } },
}),
    header = document.querySelector("header"),
    header_bottom = document.querySelector("header .header-bottom-wrap");
function menuFixed() {
    var e = header.offsetHeight - header_bottom.offsetHeight;
    document.body.scrollTop > e || document.documentElement.scrollTop > e ? header_bottom.classList.add("fixed-top") : header_bottom.classList.remove("fixed-top");
}
...
function moveCartItemInfo() {
    var e = window.innerWidth,
        t = sectionCart.querySelectorAll(".cart-item");
    e <= 1023
        ? t.forEach(function (e) {
            var t = e.querySelector(".info");
            e.querySelector(".item-desc2").appendChild(t);
        })
        : t.forEach(function (e) {
            var t = e.querySelector(".info");
            e.querySelector(".item-desc").appendChild(t);
        });
}
null != sectionCart && (moveCartItemInfo(), (window.onresize = moveCartItemInfo));
const modalShadow = document.querySelector(".modal-shadow"),
    modals = document.querySelectorAll(".modal"),
    btnsModalClose = document.querySelectorAll(".modal .btn-close");
btnsModalClose.forEach(function (e) {
    e.onclick = function () {
        modalShadow.classList.remove("show"),
            e.closest(".modal").classList.remove("show"),
            (document.querySelector("body").style.overflow = ""),
            null != document.querySelector("#btnFiltersOpen") && document.querySelector("#btnFiltersOpen").classList.remove("active");
    };
}),
...
const btnHeaderSearchOpen = document.querySelector("#btnSearchOpen"),
    btnMobileSearchOpen = document.querySelector("#btnSearchOpenMobile"),
    modalSearch = document.querySelector(".modal-search");
(btnHeaderSearchOpen.onclick = function () {
    modalShadow.classList.add("show"), modalSearch.classList.add("show"), (document.querySelector("body").style.overflow = "hidden");
}),
    (btnMobileSearchOpen.onclick = function () {
        modalShadow.classList.add("show"), modalSearch.classList.add("show"), (document.querySelector("body").style.overflow = "hidden");
    });
const btnHeaderContactsOpen = document.querySelector("#btnContactsOpen"),
    btnMobileContactsOpen = document.querySelector("#btnContactsOpenMobile"),
    modalContacts = document.querySelector(".modal-contacts");
(btnHeaderContactsOpen.onclick = function () {
    modalShadow.classList.add("show"), modalContacts.classList.add("show"), (document.querySelector("body").style.overflow = "hidden");
}),
    (btnMobileContactsOpen.onclick = function () {
        modalShadow.classList.add("show"), modalContacts.classList.add("show"), (document.querySelector("body").style.overflow = "hidden");
    });
const btnHeaderCatalogOpen = document.querySelector("#btnCatalogOpen"),
    modalCatalog = document.querySelector(".modal-catalog");
if (
    ((btnHeaderCatalogOpen.onclick = function () {
        modalShadow.classList.add("show"), modalCatalog.classList.add("show"), (document.querySelector("body").style.overflow = "hidden");
    }),
        null != document.querySelector("#btnFactoriesOpen"))
) {
    const n = document.querySelector("#btnFactoriesOpen"),
        l = document.querySelector(".modal-factories");
    n.onclick = function () {
        modalShadow.classList.add("show"), l.classList.add("show"), (document.querySelector("body").style.overflow = "hidden");
    };
}
if (null != document.querySelector("#btnFiltersOpen")) {
    const o = document.querySelector("#btnFiltersOpen"),
        d = document.querySelector(".modal-filters");
    o.onclick = function () {
        o.classList.add("active"), modalShadow.classList.add("show"), d.classList.add("show"), (document.querySelector("body").style.overflow = "hidden");
    };
}
if (null != document.querySelector("#btnRequestPrice")) {
    const c = document.querySelector("#btnRequestPrice"),
        p = document.querySelector(".modal-request.price");
    c.onclick = function () {
        modalShadow.classList.add("show"), p.classList.add("show"), (document.querySelector("body").style.overflow = "hidden");
    };
}
if (null != document.querySelector("#btnRequest3d")) {
    const u = document.querySelector("#btnRequest3d"),
        m = document.querySelector(".modal-request.model3d");
    u.onclick = function () {
        modalShadow.classList.add("show"), m.classList.add("show"), (document.querySelector("body").style.overflow = "hidden");
    };
}
const modalMenuCatalog = document.querySelector(".modal-catalog"),
    modalMenuCatalog_dropdowns = document.querySelectorAll(".modal-catalog .dropdown>a");
modalMenuCatalog_dropdowns.forEach(function (e) {
    (e.onclick = function (t) {
        if ((t.preventDefault(), window.innerWidth <= 1023)) {
            var s = document.querySelector(".modal-catalog .dropdown.active"),
                a = e.closest(".dropdown"),
                i = a.querySelector(".dropdown-menu"),
                r = a.querySelectorAll(".dropdown-menu li"),
                n = 0;
            r.forEach(function (e) {
                n = +n + e.offsetHeight;
            }),
                (s.querySelector(".dropdown-menu").style.height = ""),
        ...
        (e.onmouseover = function () {
            window.innerWidth >= 1024 && (document.querySelector(".modal-catalog .dropdown.active").classList.remove("active", "show"), e.closest(".dropdown").classList.add("active"));
        });
});
const modalMenuFactories = document.querySelector(".modal-factories"),
    modalMenuFactories_tabs = document.querySelectorAll(".modal-factories .btn-symbol"),
    modalMenuFactories_menus = document.querySelectorAll(".modal-factories .menu");
if (
    (modalMenuFactories_tabs.forEach(function (e) {
        e.onclick = function () {
            var t = document.querySelector(".modal-factories .btn-symbol.active"),
                s = document.querySelector(".modal-factories .menu.show");
            t.classList.remove("active"),
                s.classList.remove("show"),
                e.classList.add("active"),
                modalMenuFactories_menus.forEach(function (t) {
                    t.dataset.tab == e.dataset.target && t.classList.add("show");
                });
        };
    }),
        null != document.querySelector("#btnFiltersOpen"))
) {
    const h = document.querySelectorAll(".modal-filters .form-group-label"),
        f = document.querySelectorAll(".modal-filters .btn-show-all"),
        v = document.querySelector(".modal-filters .btn-primary"),
        g = document.querySelector(".modal-filters .btn-reset"),
        w = document.querySelectorAll('.modal-filters input[type="checkbox"]'),
        b = document.querySelectorAll('.modal-filters input[type="radio"]'),
        y = document.querySelectorAll('.modal-filters input[type="text"]'),
        S = document.querySelector(".modal-filters form");
    h.forEach(function (e) {
        e.onclick = function () {
            var t = e.closest(".form-group"),
                s = e.closest(".form-group").querySelector(".form-group-wrap"),
                a = e.closest(".form-group").querySelector(".items"),
                i = e.closest(".form-group").querySelector(".btn-show-all");
            (s.style.height = ""), (a.style.height = ""), null != i && i.classList.remove("active"), t.classList.contains("show") ? t.classList.remove("show") : t.classList.add("show");
        };
    }),
        f.forEach(function (e) {
            e.onclick = function () {
                e.closest(".form-group");
                var t = e.closest(".form-group").querySelector(".form-group-wrap"),
                    s = e.closest(".form-group").querySelector(".items"),
                    a = e.closest(".form-group").querySelector(".items-wrap"),
                    i = e.closest(".form-group").querySelector(".btn-block");
                e.classList.contains("active")
                    ? ((t.style.height = ""), (s.style.height = ""), e.classList.remove("active"))
                    : ((t.style.height = a.offsetHeight + i.offsetHeight + "px"), (s.style.height = a.offsetHeight + "px"), e.classList.add("active"));
            };
        }),
        (v.onclick = function () {
            S.submit();
...
// if (null != document.querySelectorAll(".btn-favourites")) {
//     const E = document.querySelector("#linkFavourites"),
//         x = E.querySelector(".count");
//     document.querySelectorAll(".btn-favourites").forEach(function (e) {
//         e.onclick = function () {
//             var t = E.dataset.count;
//             e.classList.contains("active") ? (e.classList.remove("active"), (t = +t - 1)) : (e.classList.add("active"), (t = +t + 1)), (E.dataset.count = t), (x.innerHTML = t);
//         };
//     });
// }
...
if (null != document.querySelector(".section-seo")) {
    const T = document.querySelector(".section-seo .section-desc"),
        M = document.querySelector(".section-seo .desc-wrap"),
        C = document.querySelector(".section-seo .btn-show-all");
    C.onclick = function () {
        C.classList.contains("active") ? (C.classList.remove("active"), (T.style.height = "")) : (C.classList.add("active"), (T.style.height = M.offsetHeight + "px"));
    };
}
const sortBlock = document.querySelector(".sort-block");
if (null != sortBlock) {
    const L = sortBlock.querySelector(".btn-sort"),
        P = sortBlock.querySelector(".dropdown"),
        k = P.querySelector(".dropdown-wrap"),
        A = k.querySelectorAll("ul li");
    (L.onclick = function () {
        L.classList.contains("active") ? ((P.style.height = ""), L.classList.remove("active")) : ((P.style.height = k.offsetHeight + "px"), L.classList.add("active"));
    }),
        A.forEach(function (e) {
            e.onclick = function () {
                var t = k.querySelector("ul li.active");
                e.classList.contains("active") || (t.classList.remove("active"), e.classList.add("active"), (L.querySelector(".text").innerHTML = e.innerText), (P.style.height = ""), L.classList.remove("active"));
            };
        }),
        document.addEventListener("click", (e) => {
            e.target.closest(".sort-block") || ((P.style.height = ""), L.classList.remove("active"));
        });
}
// const linkCart = document.querySelector("#linkCart"),
//     linkCartMobile = document.querySelector("#linkCartMobile"),
//     cartMobile = document.querySelector(".mobile-cart");
// if (null != document.querySelector(".btn-add-in-cart")) {
//     const I = linkCart.querySelector(".count"),
//         z = linkCartMobile.querySelector(".count"),
//         O = document.querySelector(".btn-add-in-cart");
//     O.onclick = function () {
//         var e = linkCart.dataset.count;
//         O.classList.contains("in-cart") || (O.classList.add("in-cart"), (O.querySelector(".text").innerHTML = "В корзине"), (e = +e + 1)),
//             (linkCart.dataset.count = e),
//             (I.innerHTML = e),
//             (linkCartMobile.dataset.count = e),
//             (z.innerHTML = e);
//     };
// }
...
const sectionManufacturers = document.querySelector(".section-catalog.manufacturers");
if (null != sectionManufacturers) {
    const q = sectionManufacturers.querySelectorAll(".btn-symbol"),
        D = sectionManufacturers.querySelectorAll(".menu"),
        B = sectionManufacturers.querySelector(".btn-all-manufacturers"),
        H = sectionManufacturers.querySelector("nav");
    q.forEach(function (e) {
        e.onclick = function () {
            var t = sectionManufacturers.querySelector(".btn-symbol.active"),
                s = sectionManufacturers.querySelector(".menu.show");
            H.classList.remove("show-all"),
        ...
        (B.onclick = function (e) {
            e.target.classList.add("active"), H.classList.add("show-all");
        });
}
const sectionManufacturer = document.querySelector(".section-catalog.manufacturer");
if (null != sectionManufacturer) {
    const G = sectionManufacturer.querySelectorAll(".nav-tab"),
        _ = sectionManufacturer.querySelectorAll(".tab-content");
    G.forEach(function (e) {
        e.onclick = function (t) {
            t.preventDefault();
            var s = sectionManufacturer.querySelector(".nav-tab.active"),
                a = sectionManufacturer.querySelector(".tab-content.show");
...
const footerMenus = document.querySelectorAll(".footer .footer-menu .menu-title");
footerMenus.forEach(function (e) {
    e.onclick = function () {
        if (window.innerWidth <= 767) {
            var t = document.querySelector(".footer .footer-menu.active"),
                s = e.closest(".footer-menu"),
                a = s.querySelector(".menu"),
                i = s.querySelectorAll(".menu li"),
                r = 0;
            i.forEach(function (e) {
                r = +r + e.offsetHeight;
            }),
                null != t && ((t.querySelector(".menu").style.height = ""), t.classList.remove("active")),
...
if (dataVideos) {
    dataVideos.forEach(dataVideo => {
        dataVideo.addEventListener('click', () => {
            let videoUrl = dataVideo.getAttribute('data-video');

            function extractVideoId(url) {
                var regex = /(?:v=|\.be\/)([a-zA-Z0-9_-]{11})/;
                var match = url.match(regex);
                return match ? match[1] : null;
            }

            if (videoUrl.indexOf('youtu.be') != -1 || videoUrl.indexOf('youtube') != -1) {
                let videoId = extractVideoId(videoUrl);
                videoUrl = `https://www.youtube.com/embed/${videoId}`;
            }

            const iframeEl = document.createElement('iframe');
            iframeEl.setAttribute('width', '538');
            iframeEl.setAttribute('height', '302');

...
final class CurrencyTable extends PowerGridComponent
{
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Cb rate', 'cb_rate')
                ,

            Column::make('Internal rate', 'internal_rate')
                ,

            Column::make('Auto calc cbrf', 'auto_calc_cbrf')
                ->sortable()
                ->searchable(),

            Column::make('Auto multiplier', 'auto_multiplier')
                ->sortable()
                ->searchable(),

...
class StoreVendorRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'short_name.min'      => 'Минимальная длина поля "Краткое название" составляет 2 символа.',
            'short_name.max'     => 'Максимальная длина поля "Краткое название" составляет 10 символов.',

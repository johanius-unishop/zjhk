         ...
         <section class="banner">
            <div class="banner__container container">
               <div class="banner__wrapper">
                  <div class="swiper banner-slider">
                     <div class="swiper-wrapper banner-slide-wrapper">
                        <div class="swiper-slide banner-slide">
                           <div class="banner-slide__title-container">
                              <h1>КАЧЕСТВО И ГАРАНТИЯ</h1>
                              <p>по доступной цене</p>
                           </div>
                           <img src="/images/products/photo-gallery-1.png" alt="галерея">
                        </div>
                        <div class="swiper-slide banner-slide">
                           <div class="banner-slide__title-container">
                  ...
                  <div class="banner__market-wrapper">
                     <div class="banner__market-item">
                        <div class="banner__item-wrapper">
                           ...
                           <img src="/images/icons/ozon-logo.png" alt="озон" class="banner__item-img">
                        </div>
                        <img src="/images/icons/ozon-logo-2.png" alt="озон">
                     </div>
                     <div class="banner__market-item">
                        <div class="banner__item-wrapper">
                           <div class="banner__item-content">
                           ...
                           <img src="/images/icons/yandex-m-logo.png" alt="яндекс" class="banner__item-img">
                        </div>
                        <img src="/images/icons/yandex-m-logo-2.png" alt="яндекс">
                     </div>
                     <div class="banner__market-item">
                        <div class="banner__item-wrapper">
                           <div class="banner__item-content">
                           ...
                           <img src="/images/icons/instrymenty-logo.png" alt="все инструменты" class="banner__item-img">
                        </div>
                        <img src="/images/icons/instrymenty-logo-2.png" alt="все инструменты">
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="popular__wrapper">
                  ...
                  <div class="popular__grid hide-subsequent-rows">
                     ...
                     <a href="#">
                        <div class="popular__item-wrapper">
                           <div>
                              <img src="/images/products/photo-1.png" alt="товар">
                           </div>
                           <div>
                              <h5>HE-006-TE-CCT-1L-2PG16</h5>
                              <p>K000000296</p>
                           </div>
                        </div>
                     </a>
                     <a href="#">
                        <div class="popular__item-wrapper">
                           <div>
                              <img src="/images/products/photo-3.png" alt="товар">
                           </div>
                           <div>
                              <h5>HA-003-SE-BK-1L-MCV-M20</h5>
                              <p>K000000006</p>
                           </div>
                        </div>
                     </a>
                     <a href="#">
                        <div class="popular__item-wrapper">
                           <div>
                              <img src="/images/products/photo-14.png" alt="товар">
                           </div>
                           <div>
                              <h5>HK-008/0-SE-SF-2L-2PG21</h5>
                              <p>K000003531</p>
                           </div>
                        </div>
                     </a>
                     <a href="#">
                        <div class="popular__item-wrapper">
                           <div>
                              <img src="/images/products/photo-5.png" alt="товар">
                           </div>
                           <div>
                              <h5> HA-003-F-BK-1L
                              </h5>
                     ...
                     <a href="#">
                        <div class="popular__item-wrapper">
                           <div>
                              <img src="/images/products/photo-6.png" alt="товар">
                           </div>
                           <div>
                              <h5> HE-006-F-SF-1L-M20
                              </h5>
                              <p>PK00000181</p>
                           </div>
                        </div>
                     ...
                     <a href="#">
                        <div class="popular__item-wrapper">
                           <div>
                              <img src="/images/products/photo-7.png" alt="товар">
                           </div>
                           <div>
                              <h5> HSB-006-F-BK-1L
                              </h5>
                     ...
                     <a href="#">
                        <div class="popular__item-wrapper">
                           <div>
                              <img src="/images/products/photo-8.png" alt="товар">
                           </div>
                           <div>
                              <h5>HK-004/0-M-SE-2B-M25</h5>
                              <p>PK00002890</p>
                           </div>
                        </div>
                     </a>

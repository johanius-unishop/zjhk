...
@section('title', 'Редактирование производителя аналогов')
@section('content_header')
<h1>Редактирование производителя аналогов</h1>
@stop


@section('content')
<div class=" py-3  ">
    <a class="btn btn-primary" href="{{ $analogVendor->front_url }}" role="button" target="_blank"><i class="fas fa-globe"></i>
        Просмотреть на сайте</a>
</div>

@include('admin.blocks.error')

<form action="{{ route('admin.analog-vendor.update', $analogVendor->id) }}" method="POST">

    @csrf
    @method('PATCH')
    <input type="hidden" name="id" value="{{ $analogVendor->id }}">
    ...
    <div class="row">
        <div class="col-12 ">
                    ...
                    <div class="tab-content" id="custom-tabs-four-tabContent">
                        <div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                            <div class="row">
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" value="{{ @$analogVendor->name }}">
                                        @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" row="5" id="summernote">{{ $analogVendor->description }}</textarea>
                            </div> --}}
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="published" id="published" data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-on="Да" data-off="Нет" {!! @$analogVendor->published ? 'checked ' : ' ' !!}>
            ...
            <div class=" py-3 form-row justify-content-center">
                <a class="btn   btn-success " href="{{ route('admin.analog-vendor.index') }}" role="button"> <i class="fa fa-arrow-left "></i> К списку</a> &nbsp;

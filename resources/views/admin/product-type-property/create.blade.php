...
<h1>Создание подтипа товара для типа товара " {{ $product_type->name }}"</h1>
@stop
...
<form action="{{ route('admin.product-type-property.store')  }}" method="POST">
    @csrf
    ...
    <div class="row">
        <div class="col-12 ">
            ...
            <div class=" py-3 form-row justify-content-center">
                <a class="btn   btn-success " href="{{ route('admin.product-type.show', $product_type) }}" role="button"> <i class="fa fa-arrow-left "></i> К списку</a> &nbsp;

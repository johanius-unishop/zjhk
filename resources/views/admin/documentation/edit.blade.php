            ...
            <div class="card card-primary card-outline card-outline-tabs">
                ...
                <div class="card-body">
                    <div class="tab-content" id="custom-tabs-four-tabContent">
                            ...
                            <form action="{{ route('admin.documentation.update', $documentation->id) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-12 ">
                                                ...
                                                <div class="tab-content" id="custom-tabs-four-tabContent">
                                                    <div class="tab-pane fade show active" id="custom-tabs-four-home"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="type_id" class="form-label">Тип
                                                                        документа</label>
                                                                    <select class="form-control" id="type_id"
                                                                        name="type_id">
                                                                        <option value="0">---Выберите тип документа---
                                                                        </option>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="form-group"> <label for="text">Описание
                                                                        документа</label>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    <div class="col-lg-4 col-6">
                                                                        <div class="form-group">
                                                                            <label for="imageDocument">Изображение для
                                                                                документа</label>
                                                                            <input type="file" class="form-control"
                                                                                id="imageDocument" name="imageDocument">
                                                                            @error('imageDocument')
                                                        ...
                                                        <div class="card card-warning">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    <div class="col-lg-4 col-6">
                                                                        <div class="form-group">
                                                                            <label for="imageDocument">Файл документа
                                                                                (PDF)</label>
                                                                            <input type="file" class="form-control"
                                                                                id="fileDocument" name="fileDocument">
                                                                            @error('fileDocument')
                                                                                <div class="alert alert-danger">
                                                                                    {{ $message }}</div>
                                                                            @enderror
                                        ...
                                        <div class=" py-3 form-row justify-content-center">
                                            <a class="btn   btn-success " href="{{ route('admin.currency.index') }}"
                                                role="button"> <i class="fa fa-arrow-left "></i> К списку</a> &nbsp;

                                            <button type="submit" name="action" value="save-exit"
                                                class="btn btn-primary">Сохранить и
                                                закрыть</button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" name="published" id="published"
                                        ...
                                        data-on="Да" data-off="Нет" {!! @$vendor->published ? 'checked ' : ' ' !!}>
                                    <label class="form-check-label" for="exampleCheck1">Опубликовано</label>
                                </div>
                                <div class=" py-3 form-row justify-content-center">
                                    <a class="btn   btn-success " href="{{ route('admin.vendor.index') }}"
                                        role="button"> <i class="fa fa-arrow-left "></i> Отменить</a> &nbsp;
                        ...
                        <div class="tab-pane fade" id="custom-tabs-four-logo" role="tabpanel"
                            aria-labelledby="custom-tabs-four-logo-tab">
                            <livewire:logo-vendor-gallery :record="$vendor" />
                        </div>
                        <div class="tab-pane fade" id="custom-tabs-four-catalogs" role="tabpanel"
                            aria-labelledby="custom-tabs-four-catalogs-tab">

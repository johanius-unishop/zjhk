    ...
    <section class="article-page">
        <div class="article-page__container container">
            ...
            <div class="article-page__content">
                ...
                <p>В зависимости от условий эксплуатации используются <a href="{{ route('category.show', ['slug' => 'metalliceskie-salniki']) }}">металлические</a> или <a href="{{ route('category.show', ['slug' => 'plastikovye-salniki']) }}">пластиковые</a> сальники.</p>

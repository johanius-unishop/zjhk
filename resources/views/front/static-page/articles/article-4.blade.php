    ...
    <section class="article-page">
        <div class="article-page__container container">
            ...
            <div class="article-page__content">
                ...
                <p>В зависимости от условий эксплуатации используются металлические или <a href="{{ route('categories.show', ['category' => 'plastokovye-salniki']) }}">пластиковые</a> сальники.</p>

                        ...
                        <ul>
                            ...
                            @if ($remainder > 0)
                                <li>
                                    ...
                                    <img src="{{ asset('images/icons/star.svg') }}" alt="заполненная звезда оценки" class="filled-star" style="clip-path: polygon(0 0, calc(100% - {{ (1 - $remainder) * 100 }}%) 0, calc(100% - {{ (1 - $remainder) * 100 }}%) 100%, 0 100%);)">
                                </li>
                            @endif

                  ...
                  <div class="benefits__wrapper">
                     <div class="benefits__item">
                        ...
                        <p class="benefits__text">
                           Мы постоянно расширяем номенклатуру и увеличиваем количество товаров на складе
                        </p>
                     </div>
                     <div class="benefits__item">
                        <div class="benefits__title-container">
                        ...
                        <p class="benefits__text">
                           Помощь в подборе продукции, аналогичной товарам из Европы</p>
                     </div>
                     <div class="benefits__item">
                        <div class="benefits__title-container">
                     ...
                     <div class="benefits__item">
                        ...
                        <p class="benefits__text">
                           Мы являемся официальными представителями в России. Продукция проверена и сертифицирована</p>
                     </div>
                  </div>
               </div>
            </div>

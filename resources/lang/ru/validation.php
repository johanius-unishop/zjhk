...
return [
    ...
    'custom' => [
        'email' => [
            'unique' => 'Такой адрес электронной почты уже зарегистрирован на сайте.',
        ],
        'password' => [
            'confirmed' => 'Введенные Вами пароли не совпадают.'
        ],
    ],

    'unique' => [
        'email' => 'Такой адрес электронной почты уже зарегистрирован на сайте.',
    ],
    ...
    'unique'               => 'Такое значение поля :attribute уже существует1.',

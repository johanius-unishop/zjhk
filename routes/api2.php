...
Route::prefix('v1')->name('v1.')->group(function () {
    ...
    Route::prefix('/admin')->name('admin.')->group(function () {
        ...
        Route::get('/property', [App\Http\Controllers\Api\V1\ProductTypeController::class, 'property']);
        ...
        // Route::get('/test_json_group', [App\Http\Controllers\Api\V1\CartController::class, 'test_json_group']);
